 ...
 */
export type PropDiffFn<T extends unknown> = (prev: T, next: T) => boolean;
...
export interface GraphNGProps extends Themeable2 {
   ...
   */
  options?: GraphNGOptions;
}

function sameProps(prevProps: GraphNGProps, nextProps: GraphNGProps, propsToDiff: Array<string | PropDiffFn> = []) {
