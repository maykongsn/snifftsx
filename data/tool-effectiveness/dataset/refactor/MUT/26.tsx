...
const CreateModalNameInput = ({
  ...
  const handleInputChange: ComponentProps<typeof Input>["onChange"] =
    useCallback((e) => {
  ...
  const handleEmojiResetKeyDown = (
    e: React.KeyboardEvent<HTMLAnchorElement>
  ) => {
    if (
      isKeyPressed(e, Constants.KeyCodes.ENTER) ||
      isKeyPressed(e, Constants.KeyCodes.SPACE)
    ) {
      e.stopPropagation();
      handleEmojiClear();
    }
