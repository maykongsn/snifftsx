...
type ParamKeys = 'responseType' | 'clientId' | 'redirectUri' | 'state' | 'scope';
type Params = Record<ParamKeys, Nullable<string>>;
...
export default class Authorize extends React.PureComponent<Props, State> {
  ...
  public handleDeny = (): void => {
    ...
    if (
      redirectUri &&
      (redirectUri.startsWith("https://") || redirectUri.startsWith("http://"))
    ) {
        ...
        <div className="prompt">
          <div className="prompt__heading">
            <div className="prompt__app-icon">
              <img alt={"prompt icon"} src={icon} width="50" height="50" />
            </div>
            <div className="text">
              <FormattedMessage
