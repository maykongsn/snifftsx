...
export interface IssueActions {
  fetchIssues: (
    ...
    viewId?: string
  ) => Promise<Nullable<TIssuesResponse>>;
  fetchNextIssues: (groupId?: string, subGroupId?: string) => Promise<Nullable<TIssuesResponse>>;
  removeIssue: (projectId: Nullable<string>, issueId: string) => Promise<void>;
  createIssue?: (projectId: Nullable<string>, data: Partial<TIssue>) => Promise<Nullable<TIssue>>;
  quickAddIssue?: (projectId: Nullable<string>, data: TIssue) => Promise<Nullable<TIssue>>;
  updateIssue?: (projectId: Nullable<string>, issueId: string, data: Partial<TIssue>) => Promise<void>;
  removeIssueFromView?: (projectId: Nullable<string>, issueId: string) => Promise<void>;
  archiveIssue?: (projectId: Nullable<string>, issueId: string) => Promise<void>;
  restoreIssue?: (projectId: Nullable<string>, issueId: string) => Promise<void>;
  updateFilters: (
    projectId: string,
    filterType: EIssueFilterType,
    filters: IssueFilterTypes
  ) => Promise<void>;
}
...
const useProjectIssueActions = () => {
  ...
  const createIssue = useCallback(
    async (projectId: Nullable<string>, data: Partial<TIssue>) => {
      if (!workspaceSlug || !projectId) return;
  ...
  const quickAddIssue = useCallback(
    async (projectId: Nullable<string>, data: TIssue) => {
      if (!workspaceSlug || !projectId) return;
  ...
  const updateIssue = useCallback(
    async (projectId: Nullable<string>, issueId: string, data: Partial<TIssue>) => {
      if (!workspaceSlug || !projectId) return;
  ...
  const removeIssue = useCallback(
    async (projectId: Nullable<string>, issueId: string) => {
      if (!workspaceSlug || !projectId) return;
