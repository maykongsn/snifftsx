...
interface MultiComboboxBaseProps<T extends ComboboxOptionValue>
...
export type MultiComboboxProps<T extends ComboboxOptionValue> = MultiComboboxBaseProps<T> & AutoSizeConditionals;

export const MultiCombobox = <T extends ComboboxOptionValue>(props: MultiComboboxProps<T>) => {
  const {
    placeholder,
    onChange,
    value,
...
function getSelectedItemsFromValue<T extends ComboboxOptionValue>(
  value: T[] | Array<ComboboxOption<T>>,
...
function isComboboxOptions<T extends ComboboxOptionValue>(
  value: T[] | Array<ComboboxOption<T>>
