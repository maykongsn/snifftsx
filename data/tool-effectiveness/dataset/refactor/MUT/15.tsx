...
interface TooltipPluginProps {
  ...
  renderTooltip?: (alignedFrame: DataFrame, seriesIdx: FocusedIndex, datapointIdx: FocusedIndex) => React.ReactNode;
}
...
export const TooltipPlugin = ({
  ...
  const [focusedSeriesIdx, setFocusedSeriesIdx] = useState<Nullable<number>>(null);
  const [focusedPointIdx, setFocusedPointIdx] = useState<FocusedIndex>(null);
  const [focusedPointIdxs, setFocusedPointIdxs] = useState<Array<FocusedIndex>>([]);
