...
type OmittedPluginKeys = "collectionConfig" | "globalConfig" | "req";
        ...
        config.collections?.map((collection) => {
          ...
          if (isEnabled) {
            if (pluginConfig?.tabbedUI) {
              ...
              const hasOnlyEmailField =
                collection.fields?.length === 1 && emailField;
                          ...
                          : [
                              {
                                ...
                                label:
                                  collection?.labels?.singular || "Content",
                              },
                            ]),
                        {
                          fields: seoFields,
