...
const UpdateUserGroupModal = ({
  ...
  const onBackClick = useCallback<React.MouseEventHandler<HTMLButtonElement>>(
    (e) => {
      e.preventDefault();
      goBack();
    },
      ...
      <Modal.Body className="overflow--visible">
        <div className="user-groups-modal__content">
          ...
          <div className="update-buttons-wrapper">
            ...
            <button onClick={onBackClick} className="btn btn-tertiary">
              <FormattedMessage
            ...
            <SaveButton
              ...
              defaultMessage={formatMessage({
                id: "multiselect.saveDetailsButton",
                defaultMessage: "Save Details",
              })}
              savingMessage={formatMessage({
                id: "multiselect.savingDetailsButton",
