    ...
    <>
      <Component
        components={{
          ...
          CardGroup: ({ className, ...props }: Props) => {
            return (
          ...
          AccordionGroup: ({ className, ...props }: Props) => {
            return <Accordion {...props} />;
          },
          Tab: () => null,
          Tabs: ({ className, ...props }: Props) => {
          ...
          Accordion: ({ className, ...props }: Props) => {
            return (
