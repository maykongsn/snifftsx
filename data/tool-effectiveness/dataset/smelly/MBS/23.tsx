...
function PostComponent(props: Props) {
  ...
  const getClassName = () => {
    ...
    return classNames("a11y__section post", {
      ...
      "same--user":
        props.isConsecutivePost &&
        (!props.compactDisplay || props.location === Locations.RHS_COMMENT),
  ...
  if (props.isFirstReply && post.type !== Constants.PostTypes.EPHEMERAL) {
    comment = (
      <CommentedOn onCommentClick={handleCommentClick} rootId={post.root_id} />
    );
  }
  ...
  const slotBasedOnEditOrMessageView = props.isPostBeingEdited
  ...
  const showFileAttachments =
    post.file_ids && post.file_ids.length > 0 && !props.isPostBeingEdited;
    ...
    <>
      ...
      >
        {(Boolean(isSearchResultItem) ||
          (props.location !== Locations.CENTER && props.isFlagged)) && (
          <div className="search-channel__name__container" aria-hidden="true">
            {(Boolean(isSearchResultItem) || props.isFlaggedPosts) && (
              <span className="search-channel__name">{channelDisplayName}</span>
            )}
            {props.channelIsArchived && (
        ...
        <PostPreHeader
          ...
          skipPinned={
            props.location === Locations.SEARCH && props.isPinnedPosts
          }
          skipFlagged={
            props.location === Locations.SEARCH && props.isFlaggedPosts
          }
        ...
        >
          ...
          <div>
            <div className="post__header" ref={postHeaderRef}>
              <PostUserProfile {...props} isSystemMessage={isSystemMessage} />
                ...
                {((!hideProfilePicture &&
                  ...
                  <PostTime
                    ...
                    timestampProps={{
                      ...
                      style:
                        props.isConsecutivePost && !props.compactDisplay
                          ? "narrow"
                          : undefined,
                    }}
                  />
